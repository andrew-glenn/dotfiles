# Generated by Powerlevel10k configuration wizard on 2025-12-12 at 09:46 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    tmux_prefix             # tmux prefix disabled indicator
  ...
  function prompt_tmux_prefix() {
    [[ -n "$TMUX" ]] && [[ "$(tmux showw -v prefix 2>/dev/null)" == "None" ]] && p10k segment -f 196 -t '[T]'
  }
